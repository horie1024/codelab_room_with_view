...
class ReadWriteTestInstrumentation {
    ...
    fun writeReadTest() {
        ...
        wordDao.getAllWords().observeForever {
            ...
            Truth.assertThat(word?.word).isEqualTo("test")

            val word2 = it.getOrNull(1)
            Truth.assertThat(word2?.word).isEqualTo("test2")

            val word3 = it.getOrNull(2)
            Truth.assertThat(word3?.word).isEqualTo("test3")
        }
    }
